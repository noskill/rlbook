...
Note: in practice we rarely sample from this normalised distribution, e.g. often distribution of states is uniform if we ran policy constant number of steps.
