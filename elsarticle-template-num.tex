...
$V_{\pi_\theta}(s_t, a_t) = \mathbb{E}_{a \sim \pi_\theta(s)} Q_{\pi_\theta}(a_t, s_t)$
...
$\nabla_\theta J(\theta) = \sum_s \left( \sum_{t=0}^T \gamma^t P(s_t=s) \right) \sum_a \pi_\theta(a|s) \nabla_\theta \log \pi_\theta(a|s) Q^{\pi_\theta}(s,a)$
...
$\nabla_\theta J(\theta) = \sum_s d_\gamma^{\pi_\theta}(s) \sum_a \pi_\theta(a|s) \nabla_\theta \log \pi_\theta(a|s) Q^{\pi_\theta}(s,a)$
...
$\nabla_\theta J(\theta) = \sum_s d_\gamma^{\pi_\theta}(s) \sum_a \nabla_\theta \pi_\theta(a|s) Q^{\pi_\theta}(s,a)$
...
$\nabla_\theta J(\theta) = \mathbb{E}_{s \sim d_\gamma^{\pi_\theta}} \mathbb{E}_{a \sim \pi_\theta(\cdot|s)} [\nabla_\theta \log \pi_\theta(a|s) Q^{\pi_\theta}(s,a)]$

This is called the policy gradient theorem.

Effectively we can replace expectations over trajectories with expectations over state distribution.
